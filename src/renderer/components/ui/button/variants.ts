  ...
  'inline-flex items-center justify-center rounded cursor-default focus-visible:outline-none',
  {
    variants: {
      variant: {
        ...
        'ghost':
          'hover:bg-neutral-200 dark:hover:bg-neutral-800 active:bg-neutral-300/80 dark:active:bg-neutral-700/60',
        'ghost-sidebar':
          'hover:bg-neutral-200 dark:hover:bg-neutral-700/50 active:bg-neutral-00/80 dark:active:bg-neutral-600/60',
      },
      size: {
        default: 'px-3 py-1',
      },
